...
import id.go.bpkp.mobilemapbpkp.DashboardActivity;
 ...
 * {@link android.widget.PegawaiAdapter.ViewBinder} is available,
 ...
 */
public class PegawaiAdapter extends BaseAdapter implements Filterable, ThemedSpinnerAdapter {
     ...
     * Constructor
     *
     * @param context The context where the View associated with this PegawaiAdapter is running
     ...
     */
    public PegawaiAdapter(Context context, List<? extends Map<String, ?>> data,
                ...
                if (!bound) {
                    if (v instanceof Checkable) {
                        ...
                        throw new IllegalStateException(v.getClass().getName() + " is not a " +
                                " view that can be bounds by this PegawaiAdapter");
                    }
                }
            }
        }
     ...
     *
     * @see #setViewBinder(android.widget.PegawaiAdapter.ViewBinder)
     */
    ...
    /**
     * This class can be used by external clients of PegawaiAdapter to bind
     * values to views.
     *
     * You should use this class to bind values to views that are not
     * directly supported by PegawaiAdapter or to change the way binding
     * occurs for views supported by PegawaiAdapter.
     *
     * @see PegawaiAdapter#setViewImage(ImageView, int)
     * @see PegawaiAdapter#setViewImage(ImageView, String)
     * @see PegawaiAdapter#setViewText(TextView, String)
     */
    public static interface ViewBinder {
         ...
         * If this method returns false, PegawaiAdapter will attempts to handle
